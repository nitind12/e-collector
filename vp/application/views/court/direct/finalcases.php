...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-8 hide_button">
            <?php echo form_open('sdmcourt/finalcases', array('name' => 'frmDisposedOff', 'id' => 'frmDisposedOff', 'role' => 'form', 'class' => 'form-inline')); ?>
        ...
        <div class="col-sm-12">
            <div>
                            <table class="table table-striped table-bordered table-hover" style="width:100%; border:#000000 solid 1px">
                                ...
                                <tbody>
                                    <?php $i=1; ?>
                                    <?php foreach($finalcases as $caseitem){?>
                                        <tr>
                                            <td><?php echo $i++;?></td>
