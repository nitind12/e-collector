...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12 hide_button">
            <?php echo form_open('sdmcourt/searching', array('name' => 'frmReportsDM', 'id' => 'frmReportsDM', 'role' => 'form', 'class' => 'form-inline')); ?>
                <div class="panel-body">
                    ...
                    <div class="form-group col-sm-6" style="color: #ff0000; font-size: 12px">
                        <b>Note</b>: Minimum one item should be selected to view any data.
                    </div>
