<div class="navbar navbar-inverse set-radius-zero" style="background-color: #4586d6">
    <div class="container">      
        <div class="row">
            <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top: 5px; text-align: right">
                <a href="<?PHP echo site_url('web/patwariDasboard'); ?>" style="font-size: 16px;color: #fff">
                        Back to Patwari Dashboard <i class="fa fa-sign-out"></i>
                </a>
            </div>
            <div class="col-md-12 col-xs-12 col-sm-12">
                <h1 class="head" style="text-align: center;"><span style="color:#fff;text-shadow: 1px 1px 2px #000; text-transform: capitalize;"><?php echo str_replace('-', ' ', $village_name); ?></span></h1>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="tab-content">
                                <!---Village Detail-->
                                    <div class="panel panel-default" style="text-align: right;">
                                        <?php $data['village_name'] = $village_name; ?>
                                        <?php $this->load->view('patwari/onerow/editvillage', $data); ?>                               
                                    </div>
                                <!-- // -->
                                <!---DM Detail-->
                                <div class="panel panel-default">
