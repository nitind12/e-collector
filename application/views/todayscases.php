...
<head>
    ...
    <link href="<?php echo base_url('vp/assets_/css/bootstrap.css');?>" rel="stylesheet" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> 
    <!-- FONT AWESOME ICONS  -->
    <link href="<?php echo base_url('vp/assets_/css/font-awesome.css');?>" rel="stylesheet" />
    <!-- CUSTOM STYLE  -->
    <link href="<?php echo base_url('vp/assets_/css/style.css');?>" rel="stylesheet" />
    ...
    <div class="container">      
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <h1 class="head" style="text-align: center">REVENUE COURT - Today's Cases</h1>
            </div>
        </div>
    </div>
</div>
